...
- [`get_categories()`](https://khisr.damurka.com/dev/reference/metadata-helpers.md)
  ...
  [`get_program_stages()`](https://khisr.damurka.com/dev/reference/metadata-helpers.md)
  [`get_tracked_entity_types()`](https://khisr.damurka.com/dev/reference/metadata-helpers.md)
  [`get_tracked_entity_attributes()`](https://khisr.damurka.com/dev/reference/metadata-helpers.md)
  [`get_relationship_types()`](https://khisr.damurka.com/dev/reference/metadata-helpers.md)
...
- [`get_enrollment_analytics()`](https://khisr.damurka.com/dev/reference/get_enrollment_analytics.md)
  **\[experimental\]** : Retrieves Aggregated Enrollment Analytics Data
  from DHIS2
- [`get_event_analytics_aggregate()`](https://khisr.damurka.com/dev/reference/get_event_analytics_aggregate.md)
...
- [`get_complete_data_set_registrations()`](https://khisr.damurka.com/dev/reference/get_complete_data_set_registrations.md)
...
- [`tracked_entity_filter()`](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.teq%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tne%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tgt%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tge%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tlt%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tle%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tlike%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tsw%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tew%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
  [`` `%.tin%` ``](https://khisr.damurka.com/dev/reference/tracked_entity_filter.md)
...
- [`get_system_info()`](https://khisr.damurka.com/dev/reference/get_system_info.md)
  **\[experimental\]** : Get DHIS2 Instance System Information
- [`get_geo_features()`](https://khisr.damurka.com/dev/reference/get_geo_features.md)
...
- [`get_data_value_audits()`](https://khisr.damurka.com/dev/reference/get_data_value_audits.md)
  **\[experimental\]** : Get Data Value Change History from a DHIS2
  Instance
- [`get_file_resources()`](https://khisr.damurka.com/dev/reference/get_file_resources.md)

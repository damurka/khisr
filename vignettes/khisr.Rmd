...
| `get_organisation_unit_levels()`     | organisationUnitLevels     |
| `get_dimensions()`                   | dimensions                 |
| `get_user_groups()`                  | userGroups                 |
| `get_period_types()`                 | periodTypes                |
| `get_programs()`                     | programs                   |
| `get_program_stages()`               | programStages               |
| `get_tracked_entity_types()`         | trackedEntityTypes          |
| `get_tracked_entity_attributes()`    | trackedEntityAttributes     |
| `get_relationship_types()`           | relationshipTypes          |

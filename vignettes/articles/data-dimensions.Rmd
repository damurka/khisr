...
These dimensions describe **aggregate** data — facility/period totals accessed
through `get_analytics()`. DHIS2 also has a separate, individual-level data
model — tracked entities, enrollments, and events — with its own dimensions
and its own retrieval functions; see
[Tracker Data](https://khisr.damurka.com/articles/tracker.html).

...
|:---|:---|:---|
| [`get_tracked_entities()`](https://khisr.damurka.com/reference/get_tracked_entities.md) | `tracker/trackedEntities` | The people/subjects being tracked |
| [`get_enrollments()`](https://khisr.damurka.com/reference/get_enrollments.md) | `tracker/enrollments` | Their enrollment in a program |
| [`get_events()`](https://khisr.damurka.com/reference/get_events.md) | `tracker/events` | What happened at each program stage visit |
| [`get_relationships()`](https://khisr.damurka.com/reference/get_relationships.md) | `tracker/relationships` | Links between two tracker objects (e.g. an index case and a contact) |
| [`get_event_analytics()`](https://khisr.damurka.com/reference/get_event_analytics.md) | `analytics/events/query` | Aggregated/dimensional analytics over events |
| [`get_enrollment_analytics()`](https://khisr.damurka.com/reference/get_enrollment_analytics.md) | `analytics/enrollments/query` | Aggregated/dimensional analytics over enrollments |
...
| `null` | *(none — pass `NULL` to [`tracked_entity_filter()`](https://khisr.damurka.com/reference/tracked_entity_filter.md))* | Attribute has no value |
| `!null` | *(none — pass `NULL` to [`tracked_entity_filter()`](https://khisr.damurka.com/reference/tracked_entity_filter.md))* | Attribute has a value |
...
filtering, so
[`get_events()`](https://khisr.damurka.com/reference/get_events.md) has
no `filter` argument. If your instance supports this via an undocumented
parameter, pass it through `...`; otherwise retrieve the broader event
set and filter client-side after unnesting `dataValues`.

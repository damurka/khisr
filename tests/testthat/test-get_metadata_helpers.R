test_that("get_metadata_helpers functions work", {
    ...
    expect_no_error(get_option_group_sets())
    ...
    expect_no_error(get_programs())
    expect_no_error(get_program_stages())
    expect_no_error(get_tracked_entity_types())
    expect_no_error(get_tracked_entity_attributes())
    expect_no_error(get_relationship_types())
})
